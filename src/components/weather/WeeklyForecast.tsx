...
export default function WeeklyForecastView({ forecasts }: Props): JSX.Element {
  return (
      ...
      <div className="flex gap-2">
        {forecasts.map((forecast) => {
          ...
          const reliabilityClass =
            RELIABILITY_CLASS[forecast.reliability] ?? "text-gray-400";
          ...
          return (
            ...
            >
              <span className={`text-sm font-medium ${dayColorClass}`}>
                {dayLabel}
              </span>
              ...
              <span className={`text-xs ${reliabilityClass}`}>
